                            ...
                            <table class="table" id="invoice_details">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <input type="number" name="quantity[]" step="0.1" id="quantity" class="quantity form-control">
                                            @error('quantity')<span class="help-block text-danger">{{$message}}</span>@enderror
                                        </td>

                                        <td>
                                            <input type="number" name="unit_price[]" step="0.1" id="unit_price" class="unit_price form-control">
                                            @error('unit_price')<span class="help-block text-danger">{{$message}}</span>@enderror
                                        </td>

                                        <td>
                                            <input type="number" step="0.1" name="row_sub_total[]" id="row_sub_total" class="row_sub_total form-control">
                                ...
                                <tr>
                                    ...
                                    <td><input type="number" step="0.01" name="sub_total" id="sub_total" class="sub_total form-control" ></td>
                                </tr>
                                    ...
                                    <td>
                                        <div class="input-group mb-3">
                                            <select name="discount_type" id="discount_type" class="discount_type custom-select">
                                                ...
                                                <option value="percentage">pourecrt</option>
                                            </select>
                                ...
                                <tr>
                                    <td colspan="3"></td>
                                    <td colspan="2">vat</td>
                                    <td><input type="number" step="0.1" name="vat_value" id="vat_value" class="vat_value form-control" ></td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td><input type="number" step="0.1" name="total_due" id="total_due" class="total_due form-control" ></td>
                                </tr>
                                </tfoot>
                            </table>
                        </div>
